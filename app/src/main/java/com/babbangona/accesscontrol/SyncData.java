                ...
                try {
                    ...
                    try {
                        ...
                        if (a == 0) {
                            if (b == 0) {
                                if (c == 0) {
                                }  else if(c<0) { app_names.add(AppName); }
                            } else if(b<0) { app_names.add(AppName); }
                        }  else if(a<0) { app_names.add(AppName); }
      ...
      ControlDB controlDB;
        ...
        AppVersionDatabaseController.DatabaseHelper databaseHelper = new AppVersionDatabaseController.DatabaseHelper(context);
            ...
            try{
                ...
                } else{return("connection error, unable to communicate with the online server");}


            }catch (IOException e){
                e.printStackTrace(); return "No internet connection. Please check your internet connection and try again";
            }
